package dev.evangelion.client.gui.font;
            ...
            for (int index = 0; index < parts.length; ++index) {
                ...
                if (!part.isEmpty()) {
                    if (index == 0) {
                        ...
                        if (strikeThrough) {
                            drawLine(width / 2.0 + 1.0, currentFont.getHeight() / 3.0, (width + currentFont.getStringWidth(words)) / 2.0 + 1.0, currentFont.getHeight() / 3.0, this.getHeight() / 16.0f);
                        }
                        if (underline) {
                            drawLine(width / 2.0 + 1.0, currentFont.getHeight() / 2.0, (width + currentFont.getStringWidth(words)) / 2.0 + 1.0, currentFont.getHeight() / 2.0, this.getHeight() / 16.0f);
                        }
